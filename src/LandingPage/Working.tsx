...
const Working = () => {
  return (
    <div className="mt-20 pb-5">
      <div className="  text-4xl font-semibold text-mine-shaft-100 text-center pb-5 mb-3">
        How it <span className="text-bright-sun-400">Works</span>
      </div>
      <div className="text-lg mx-auto mb-10 text-mine-shaft-300 text-center w-1/2">
        Effortlessouly navigate through the process and land your dream job
      </div>
      <div className="flex  px-16 justify-between items-center">
        <div className="relative">
          <img className="w-[30rem]" src="/Working/Girl.png" alt="girl" />
          <div className="w-36 flex flex-col top-[15%] absolute right-0  items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md">
            ...
            <div className="text-xs text-mine-shaft-300" >70% Compelted</div>
          </div>
        </div>
