...
const JobCategory = () => {
  return (
    <div className="mt-20 pb-20">
      <div className=" mb-3 text-4xl font-semibold text-mine-shaft-100 text-center pb-5 mb-10">
    ...
    >
        ...
        <div className="text-bright-sun-300 text-lg">{category.jobs} New Job's Posted</div>
      </div>
            </Carousel.Slide>)
        }
