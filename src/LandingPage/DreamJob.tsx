    ...
    <div className="flex items-center px-16">
      <div className="flex flex-col w-[45%] gap-3">
        ...
        <div className="text-lg text-mine-shaft-100">
          {" "}
          Good life begins with good compnay.Start explore thousand of jobs in
          one place
        </div>
        ...
        <div className="w-[30rem] relative">
          ...
          <div className="absolute -left-5 w-fit top-[28%] border-bright-sun-400 border rounded-lg p-2 backdrop-blur-md gap-3 flex flex-col">
            <div className="flex gap-2 items-center " >
              <div className="w-10 h-10 p-1 bg-mine-shaft-900 rounded-lg"> <img src="/Google.png" alt="" /></div>
              <div className="text-sm text-mine-shaft-100">
                <div className=""> Software Engineer</div>
                <div className="text-mine-shaft-200 text-xs">New Work</div>
              </div>
            </div>
